...
const Pay = () => {
    ...
    /**
     * call api order trong database roi moi lay ra
     * lu0ong di roi qua
     *
     * khong dunf cart state de render ra nua
     *
     * => tao api dung de get ra cai order theo id, get all order
     *
     * useEffect de render ra
     */
